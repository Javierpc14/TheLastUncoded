...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Header("Parametros de movimiento del Jugador")]
    ...
    void Movement()
    {
        //Comprobamos si esta en el suelo
        ...
        //Si el jugador esta en el suelo puede saltar
    ...
    void Morir()
    {
        ...
        //clase de unity que me permite guardar valores entre escenas
        PlayerPrefs.SetInt("Oleadas", EnemyController.oleadasSobrevividas);
        Debug.Log("OLEADAS (PlayerPrefs): " + EnemyController.oleadasSobrevividas);
        PlayerPrefs.SetInt("Enemigos", EnemyHealth.enemigosMuertos);
        Debug.Log("Enemigos (PlayerPrefs): " + EnemyHealth.enemigosMuertos);
        PlayerPrefs.Save();

        //cambiamos de escena a la de muerte
